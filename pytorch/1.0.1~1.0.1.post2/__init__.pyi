...
from torch import nn, cuda, functional, optim, autograd, onnx, utils
from torch import contrib, distributions, for_onnx, jit, multiprocessing
from torch import sparse
from torch.storage import _StorageBase as Storage
...
class Tensor:
    ...
    def new_full(self, size: Union[list, tuple, torch.Size], fill_value: Union[float, int], dtype=None, device=None, requires_grad=False) -> Tensor: ...

    def new_empty(self, size: Union[list, tuple, torch.Size], dtype=None, device=None, requires_grad=False) -> Tensor: ...

    def new_ones(self, size: Union[list, tuple, torch.Size], dtype=None, device=None, requires_grad=False) -> Tensor: ...

    def new_zeros(self, size: Union[list, tuple, torch.Size], dtype=None, device=None, requires_grad=False) -> Tensor: ...
    ...
    def stride(sefl, dim: int) -> Union[tuple, int] : ...
    ...
    https://pytorch.org/docs/stable/tensors.html#torch.Tensor.type
    '''
    def type(self, dtype=None, non_blocking: bool=False, **kwargs) -> Union[Tensor, str]: ...
    ...
    def clamp(self, min: Optional[float], max: Optional[float], *, out: Optional[Tensor]=None) -> Tensor: ...

    def clamp_(self, min: Optional[float], max: Optional[float]) -> Tensor: ...
...
def clamp(self: Tensor, min: Optional[float], max: Optional[float], *, out: Optional[Tensor]=None) -> Tensor: ...
