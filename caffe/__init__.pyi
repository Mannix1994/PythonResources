from typing import Tuple, Optional, Union, overload, Any, Callable
...
# -------------help(caffe.Net)-------------
class Net:
    def __init__(self, network_file: str, phase: Optional[int]=TRAIN, level: Optional[int]=0, stages: Optional[str]=None , weights: Optional[str]=None): ...

    @overload
    def __init__(self, network_file: str, weights: str,  phase: Optional[int]=TRAIN): ...


    def after_backward(self, callback: Optional[Callable]) -> None : ...
    ...
    def copy_from(self, net: str, ) -> None : ...
    ...
    def share_with(self, net: Net) -> None : ...
